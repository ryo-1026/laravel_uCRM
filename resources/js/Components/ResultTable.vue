...
<template>
    ...
    <div v-if="data.type === 'rfm'" class="lg:w-2/3 w-full mx-auto overflow-auto">
        <h2 class="text-center text-2x1 my-4">RFM 分析結果</h2>

        <div class="my-4 text-center">合計人数: {{ data.totals }}　人</div>

        <h3 class="text-center text-2x1 my-4">RFMランク毎の人数</h3>
        <table class="table-auto w-full text-left whitespace-no-wrap">
            <thead>
                <tr>
        ...
        <h3 class="text-center text-2x1 my-4">RとFの集計表</h3>
